...
def get_co(file_name=None) -> os.path:
    """Returns cluster output folder or a file in that folder if you specify a file name"""
    if file_name:
...
def get_tsmt(file_name=None) -> os.path:
    """Returns tree segmentation model train folder or a file in that folder if you specify a file name"""
    if file_name:
...
def get_tsme(file_name=None) -> os.path:
    """Returns tree segmentation model evaluation folder or a file in that folder if you specify a file name"""
    if file_name:
...
def get_tsm(file_name=None) -> os.path:
    """Returns tree segmentation model folder or a file in that folder if you specify a file name"""
    if file_name:
...
def get_ct(file_name=None) -> os.path:
    """Returns classifier tree folder or a file in that folder if you specify a file name"""
    if file_name:
...
def get_c(file_name=None) -> os.path:
    """Returns classifier folder or a file in that folder if you specify a file name"""
    if file_name:
